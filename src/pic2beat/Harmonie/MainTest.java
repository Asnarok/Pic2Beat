...
public class MainTest {
	...
	public Map<Chord, Map<Chord, Map<Chord, Integer>>> MatriceProba0 = new HashMap(); // abscisse = accord passé, ordonnée = présent, Zaxis = choix & pondé
	public ArrayList<int[]> a;

	public static void main (String [] args) {

		final String MOOD = "HAPPY";
		final int LENGTH = 10; //longueur du morceau en mesures
		...
		case "HAPPY" :
			...
			/*
			Degres.add(Tonalite);
			//Degres.add(new Chord(fon+2, ));

			break;
		}
		/*int a = (int)(Math.random()*12);
		int b =(int)( Math.random()*4);
		Progression.add(new Chord(a, b));
	...
	public static Map<Chord, Map<Chord, Integer>> InitMatProba() {
		...
		deg1.put(new Chord(Tonalite.interval(numTon,7), 0), 24);//V	// Données récupérées sur https://www.hooktheory.com/trends#node=1&key=A
